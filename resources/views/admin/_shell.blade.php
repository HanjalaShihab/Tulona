...
<div class="admin-shell" id="admin-shell">
  ...
  <aside class="admin-side" id="admin-side">
    ...
    <a href="{{ route('admin.scrape-post.index') }}" class="{{ request()->routeIs('admin.scrape-post.*') || request()->routeIs('admin.csv-drafts.*') ? 'active' : '' }}"><span class="side-ico">✇</span><span>Scrape &amp; Post</span></a>
